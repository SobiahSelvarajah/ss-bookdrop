...
export default function TestimonialsCard({
    ...
    return (
        <article className="relative mx-auto max-w-4xl rounded-3xl border border-stone-800 bg-stone-950/60 p-10 text-center shadow-xl backdrop-blur-sm md:p-16">
            <span 
                aria-hidden="true" 
                className="absolute left-8 top-6 font-heading text-7xl text-amber-300/20 md:text-9xl"
            >
                "
            </span>
            <blockquote className="relative z-10 flex min-h-64 items-center justify-center">
                <p className="mx-auto max-w-3xl font-heading text-3xl leading-relaxed text-stone-100 md:text-4xl">
                    {quote}
                </p>
            </blockquote>
            <span 
                aria-hidden="true" 
                className="absolute bottom-24 right-8 font-heading text-7xl text-amber-300/20 md:text-9xl"
            >
                "
            </span>
