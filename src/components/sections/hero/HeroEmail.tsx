    ...
    return (
        ...
        >
            <div className="relative w-full max-w-lg">
                ...
                <div className="relative rounded-3xl border border-stone-700 bg-stone-950/80 p-5 shadow-[0_25px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl transition-transform duration-500 sm:p-6 lg:rotate-2">
                    <HeroEmailHeader />
                    <HeroEmailIntro />
